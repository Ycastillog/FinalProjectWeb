...
class IncidentController {
  ...
  public function store(): void {
    if ($_SERVER['REQUEST_METHOD']!=='POST'){ header('Location: /incidencias/public/incidents'); exit; }
    ...
    $d = [
      ...
      'province_id'=>$_POST['province_id'] ?: null, 'municipality_id'=>$_POST['municipality_id'] ?: null, 'barrio_id'=>$_POST['barrio_id'] ?: null,
      'lat'=>$_POST['lat'] ?: null, 'lng'=>$_POST['lng'] ?: null,
      'dead'=>$_POST['dead'] ?: null, 'injured'=>$_POST['injured'] ?: null, 'loss_rd'=>$_POST['loss_rd'] ?: null,
      'social_link'=>$_POST['social_link'] ?: null, 'photo'=>$photo,
      'type_ids'=>$_POST['type_ids'] ?? []
    ];
    if ($d['title']==='' || $d['description']===''){ echo "Título y descripción son obligatorios."; return; }

    $userId=null; (new Incidents())->create($d,$userId);
